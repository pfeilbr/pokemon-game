      ...
      {step === 'name' ? (
        <Panel className="flex flex-col gap-4">
          ...
          <input
            ...
            autoFocus
            className="w-full rounded-2xl bg-slate-950/70 px-5 py-5 text-2xl font-bold text-white ring-2 ring-white/15 outline-none placeholder:text-slate-600 focus:ring-amber-300"
          />
